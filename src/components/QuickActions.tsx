...
export function QuickActions({ onNewFlow }: QuickActionsProps) {
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
      <h2 className="text-xl text-slate-100 mb-6">Quick Actions</h2>
      <div className="space-y-4">
        {/* Primary Action */}
        <button
          onClick={onNewFlow}
          className="w-full bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white px-6 py-4 rounded-lg flex items-center justify-center gap-3 transition-all shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50"
        >
